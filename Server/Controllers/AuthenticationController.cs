...
namespace MyChat.Server.Controllers {
    ...
    public class AuthenticationController : ControllerBase {
        ...
        public CurrentUser CurrentUserInfo() {
            return new CurrentUser { IsAuthenticated = User.Identity.IsAuthenticated, UserName = User.Identity.Name, Claims = User.Claims.ToDictionary(c => c.Type, c => c.Value) };
        }
    }
}
